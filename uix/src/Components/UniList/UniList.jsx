...
const UniList = () => {
  ...
  const getPlaces = (page) => {
    setLoading(true);
    axiosClient
      .get(`/academic_list?page=${page}&per_page=10`)
      .then(({ data }) => {
        setPlaces(data.data);
  ...
  const onSubmit = (ev) => {
    ...
    if (isEditing && currentPlace?.id) {
      axiosClient
        .put(`/academic_list/${currentPlace.id}`, dataToSend)
        .then(({ data }) => {
          ...
          <div className="modal">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(ev) => setFormData({ ...formData, established_year: ev.target.value })}
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(ev) => setFormData({ ...formData, website: ev.target.value })}
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(ev) => setFormData({ ...formData, contact_email: ev.target.value })}
